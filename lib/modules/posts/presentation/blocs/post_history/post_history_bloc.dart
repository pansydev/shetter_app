...
class PostHistoryBlocProvider extends ViewModelProvider<PostHistoryBloc> {
  PostHistoryBlocProvider({
    Post? post,
    super.key,
    super.child,
  }) : super(
          (_, sp) => PostHistoryBloc(sp.getRequired<PostRepository>(), post),
        );
}
...
class PostHistoryBloc extends Bloc<PostHistoryEvent, PostHistoryState> {
  PostHistoryBloc(this._postRepository, Post? post)
