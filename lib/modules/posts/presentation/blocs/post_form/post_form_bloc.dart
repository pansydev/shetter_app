...
class PostFormBlocProvider extends ViewModelProvider<PostFormBloc> {
  PostFormBlocProvider({
    Post? post,
    super.key,
    super.child,
  }) : super(
          (_, sp) => PostFormBloc(sp.getRequired<PostRepository>(), post),
        );
}

class PostFormBloc extends Bloc<PostFormEvent, PostFormState> {
  PostFormBloc(this._postRepository, Post? post)
      : super(
  ...
  Future<bool> sendPost() async {
    add(const PostFormEvent.sendPost());
